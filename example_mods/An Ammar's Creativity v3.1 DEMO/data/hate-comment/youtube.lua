...
function onCreatePost()
    shaderE = getDataFromSave("ammarc", "shaders") and getPropertyFromClass("ClientPrefs", "shaders")
    if shaderE then 
    ...
    runHaxeCode("game.getLuaObject('redGlow').camera = camEffect")
